...
class TestUtils extends AnyFlatSpec:
  ...
  def testClientLauncher(): Unit =
    ...
    val childProcessLauncher = ClientLauncher(9999, Queue("powershell -ExecutionPolicy Bypass -File src/test/powershell/testClientLauncher.ps1", "test"), probe.ref, probe.ref)
